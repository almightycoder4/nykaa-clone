...
// 
let initData2 =async()=>{
  let response2 =await fetch(`http://localhost:3000/posts2`)
...
let initData3 =async()=>{
  let response3 =await fetch(`http://localhost:3000/products`)
...
// influencers
let initData4 =async()=>{
  let response4 =await fetch(`http://localhost:3000/influencer`)
